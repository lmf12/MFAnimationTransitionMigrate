//
//  MFAnimationTransitionMigrateExit.m
//  testCollectionView
//
...
@implementation MFAnimationTransitionMigrateExit
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    NSArray *keys = [[fromViewController mf_targetViewKeys] allKeys];
    for (NSString *key in keys) {
        if ([[toViewController mf_sourceViewKeys] objectForKey:key]) {
            [sourceViewList addObject:[[fromViewController mf_targetViewKeys] objectForKey:key]];
            [targetViewList addObject:[[toViewController mf_sourceViewKeys] objectForKey:key]];
        }
    }
